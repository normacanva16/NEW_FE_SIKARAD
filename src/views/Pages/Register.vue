    ...
    <div class="block-center mt-4 wd-xl">
        ...
        <div class="card card-flat">
            ...
            <div class="card-body">
                ...
                <form class="mb-3" @submit.prevent="validateBeforeSubmit('register')" data-vv-scope="register">
                    <div class="form-group">
                        ...
                        <div class="input-group with-focus">
                            <input :class="{'form-control border-right-0':true, 'is-invalid': errors.has('register.email')}" placeholder="Enter email" v-model="register.email" v-validate="'required|email'" type="text" name="email"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group with-focus">
                            <input ref="password1" :class="{'form-control border-right-0':true, 'is-invalid': errors.has('register.password1')}" v-model="register.password1" v-validate="'required'" type="password" name="password1" placeholder="Password"/>
                            <div class="input-group-append">
                                <span class="input-group-text text-muted bg-transparent border-left-0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group with-focus">
                            <input :class="{'form-control border-right-0':true, 'is-invalid': errors.has('register.password2')}" v-model="register.password2" v-validate="'required|confirmed:password1'" type="password" name="password2" placeholder="Retype Password"/>
                            <div class="input-group-append">
                                <span class="input-group-text text-muted bg-transparent border-left-0">
                                    <em class="fa fa-lock"></em>
                                </span>
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" :class="{'custom-control-input':true, 'is-invalid': errors.has('register.agreements')}" v-model="register.agreements" v-validate="'required'" name="agreements" id="registeragree">
                ...
                <router-link class="btn btn-block btn-secondary" to="/panel">Signup</router-link>
            </div>
        </div>
        <!-- END card-->
